...
class AG:
    ...
    def ContinuosMutation(self, s, theta = 0.3):
        value = np.random.randint(len(s)-1)
    ...
    def solve(self, fo = func_obj, dim_pop = 100, dim_s = 6, tx_cross = 0.6, tx_mutation = 0.3, it = 1000, neuralnet = False, env = False, params_nn = False,  onehot_encode = False):
        ...
        for k in range(it):
            ...
            w = vetor_to_weigths(self.best_s[1:], params_nn)
